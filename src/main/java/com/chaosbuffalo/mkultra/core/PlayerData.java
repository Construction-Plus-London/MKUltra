...
import com.chaosbuffalo.mkultra.core.sync.SyncFloat;
import com.chaosbuffalo.mkultra.core.sync.SyncResourceLocation;
...
public class PlayerData implements IPlayerData {
    ...
    private SyncFloat mana = new SyncFloat("mana", 0f);
    private PlayerCastingState currentCast;
    private SyncResourceLocation activeClassId = new SyncResourceLocation("activeClassId", MKURegistry.INVALID_CLASS);
