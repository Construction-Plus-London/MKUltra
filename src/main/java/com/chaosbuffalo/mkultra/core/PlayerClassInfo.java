...
import com.chaosbuffalo.mkultra.core.sync.ISyncObject;
import com.chaosbuffalo.mkultra.core.sync.SyncInt;
...
public class PlayerClassInfo implements ISyncObject {
    private PlayerClass playerClass;
    private ResourceLocation classId;
    private SyncInt level = new SyncInt("level", 1);
    private SyncInt unspentAbilityPoints = new SyncInt("unspentPoints", 1);
    private SyncInt totalTalentPoints = new SyncInt("totalTalentPoints", 0);
    private SyncInt unspentTalentPoints = new SyncInt("unspentTalentPoints", 0);
...
//        Log.info(tag.toString());
    ...
    class ActiveAbilityUpdater implements ISyncObject {
